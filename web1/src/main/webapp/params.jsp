...
<p>
    ...
    Но!
    Если пакет содержит тело, то нужно указывать заголовок "Content-Type", определяющий
    как декодировать содержимое. Для данных формы -
    это "application/x-www-form-urlencoded" - по умолчанию,
